...
from Package.learningratefinder import LearningRateFinder
from Package.detectionnetwork import DetectionNetwork
...
weight = classTotals.max() / classTotals
classWeight = dict(enumerate(weight.flatten(), 0))
...
model = DetectionNetwork.build(width=128, height=128, depth=3,
	classes=2)
